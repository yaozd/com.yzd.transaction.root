package com.yzd.db.account.dao.conf.mybatis;
...
import com.yzd.db.account.dao.conf.mybatis.dataSource.DynamicDataSource;
...
@MapperScan(basePackages = "com.yzd.db.account.dao.mapper")
